...
typedef struct wire_PaymentMetadataFilter {
  struct wire_uint_8_list *search_path;
  struct wire_uint_8_list *search_value;
} wire_PaymentMetadataFilter;

typedef struct wire_list_payment_metadata_filter {
  struct wire_PaymentMetadataFilter *ptr;
  int32_t len;
} wire_list_payment_metadata_filter;

typedef struct wire_ListPaymentsRequest {
  struct wire_list_payment_type_filter *filters;
  struct wire_list_payment_metadata_filter *metadata_filters;
...
struct wire_list_payment_metadata_filter *new_list_payment_metadata_filter_0(int32_t len);
...
static int64_t dummy_method_to_enforce_bundling(void) {
    ...
    dummy_var ^= ((int64_t) (void*) new_list_payment_metadata_filter_0);
