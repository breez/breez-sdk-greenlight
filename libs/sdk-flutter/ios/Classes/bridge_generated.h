...
void wire_check_initialized(int64_t port_);
...
void wire_convert_mnemonic_to_seed(int64_t port_, struct wire_uint_8_list *phrase);

void wire_get_default_config(int64_t port_,
                             int32_t env_type,
                             struct wire_uint_8_list *api_key,
                             struct wire_NodeConfig *node_config);
...
void wire_get_lsp_id(int64_t port_);
...
void wire_get_backup_status(int64_t port_);

void wire_parse_invoice(int64_t port_, struct wire_uint_8_list *invoice);

void wire_parse_input(int64_t port_, struct wire_uint_8_list *s);
...
void wire_get_payment_by_hash(int64_t port_, struct wire_uint_8_list *hash);
...
void wire_list_refundable_swaps(int64_t port_);
...
void wire_get_in_progress_swap(int64_t port_);

void wire_list_in_progress_reverse_swaps(int64_t port_);

void wire_fetch_reverse_swap_fees(int64_t port_);

void wire_fetch_recommended_fees(int64_t port_);
...
static int64_t dummy_method_to_enforce_bundling(void) {
    ...
    dummy_var ^= ((int64_t) (void*) wire_check_initialized);
    dummy_var ^= ((int64_t) (void*) wire_sync_node);
    dummy_var ^= ((int64_t) (void*) wire_get_node_state);
    dummy_var ^= ((int64_t) (void*) wire_stop_node);
    dummy_var ^= ((int64_t) (void*) wire_convert_mnemonic_to_seed);
    dummy_var ^= ((int64_t) (void*) wire_get_default_config);
    ...
    dummy_var ^= ((int64_t) (void*) wire_get_lsp_id);
    ...
    dummy_var ^= ((int64_t) (void*) wire_get_backup_status);
    ...
    dummy_var ^= ((int64_t) (void*) wire_get_payment_by_hash);
    ...
    dummy_var ^= ((int64_t) (void*) wire_list_refundable_swaps);
    dummy_var ^= ((int64_t) (void*) wire_refund_swap);
    dummy_var ^= ((int64_t) (void*) wire_get_in_progress_swap);
    dummy_var ^= ((int64_t) (void*) wire_list_in_progress_reverse_swaps);
    dummy_var ^= ((int64_t) (void*) wire_fetch_reverse_swap_fees);
    dummy_var ^= ((int64_t) (void*) wire_fetch_recommended_fees);
