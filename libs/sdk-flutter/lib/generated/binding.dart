...
Future<void> connect({required ConnectRequest req, dynamic hint}) =>
    BreezSdkBindings.instance.api.connect(req: req, hint: hint);

/// Check whether node service is initialized or not
Future<bool> isInitialized({dynamic hint}) => BreezSdkBindings.instance.api.isInitialized(hint: hint);

/// See [BreezServices::sync]
Future<void> sync({dynamic hint}) => BreezSdkBindings.instance.api.sync(hint: hint);

/// See [BreezServices::node_credentials]
Future<NodeCredentials?> nodeCredentials({dynamic hint}) =>
    BreezSdkBindings.instance.api.nodeCredentials(hint: hint);

/// See [BreezServices::node_info]
Future<NodeState> nodeInfo({dynamic hint}) => BreezSdkBindings.instance.api.nodeInfo(hint: hint);

/// See [BreezServices::configure_node]
Future<void> configureNode({required ConfigureNodeRequest req, dynamic hint}) =>
    BreezSdkBindings.instance.api.configureNode(req: req, hint: hint);

/// Cleanup node resources and stop the signer.
Future<void> disconnect({dynamic hint}) => BreezSdkBindings.instance.api.disconnect(hint: hint);

/// See [BreezServices::sign_message]
Future<SignMessageResponse> signMessage({required SignMessageRequest req, dynamic hint}) =>
    BreezSdkBindings.instance.api.signMessage(req: req, hint: hint);

/// See [BreezServices::check_message]
Future<CheckMessageResponse> checkMessage({required CheckMessageRequest req, dynamic hint}) =>
    BreezSdkBindings.instance.api.checkMessage(req: req, hint: hint);

/// See [breez_services::mnemonic_to_seed]
Future<Uint8List> mnemonicToSeed({required String phrase, dynamic hint}) =>
    BreezSdkBindings.instance.api.mnemonicToSeed(phrase: phrase, hint: hint);
...
Future<StaticBackupResponse> staticBackup({required StaticBackupRequest req, dynamic hint}) =>
    BreezSdkBindings.instance.api.staticBackup(req: req, hint: hint);
...
Future<ServiceHealthCheckResponse> serviceHealthCheck({required String apiKey, dynamic hint}) =>
    BreezSdkBindings.instance.api.serviceHealthCheck(apiKey: apiKey, hint: hint);

/// If used, this must be called before `connect`. It can only be called once.
Stream<BreezEvent> breezEventsStream({dynamic hint}) =>
    BreezSdkBindings.instance.api.breezEventsStream(hint: hint);

/// If used, this must be called before `connect`. It can only be called once.
Stream<LogEntry> breezLogStream({dynamic hint}) => BreezSdkBindings.instance.api.breezLogStream(hint: hint);

/// See [BreezServices::list_lsps]
Future<List<LspInformation>> listLsps({dynamic hint}) => BreezSdkBindings.instance.api.listLsps(hint: hint);

/// See [BreezServices::connect_lsp]
Future<void> connectLsp({required String lspId, dynamic hint}) =>
    BreezSdkBindings.instance.api.connectLsp(lspId: lspId, hint: hint);

/// See [BreezServices::lsp_id]
Future<String?> lspId({dynamic hint}) => BreezSdkBindings.instance.api.lspId(hint: hint);

/// See [BreezServices::fetch_lsp_info]
Future<LspInformation?> fetchLspInfo({required String id, dynamic hint}) =>
    BreezSdkBindings.instance.api.fetchLspInfo(id: id, hint: hint);

/// See [BreezServices::lsp_info]
Future<LspInformation> lspInfo({dynamic hint}) => BreezSdkBindings.instance.api.lspInfo(hint: hint);

/// See [BreezServices::close_lsp_channels]
Future<void> closeLspChannels({dynamic hint}) => BreezSdkBindings.instance.api.closeLspChannels(hint: hint);

Future<void> registerWebhook({required String webhookUrl, dynamic hint}) =>
    BreezSdkBindings.instance.api.registerWebhook(webhookUrl: webhookUrl, hint: hint);

Future<void> unregisterWebhook({required String webhookUrl, dynamic hint}) =>
    BreezSdkBindings.instance.api.unregisterWebhook(webhookUrl: webhookUrl, hint: hint);

/// See [BreezServices::backup]
Future<void> backup({dynamic hint}) => BreezSdkBindings.instance.api.backup(hint: hint);

/// See [BreezServices::backup_status]
Future<BackupStatus> backupStatus({dynamic hint}) => BreezSdkBindings.instance.api.backupStatus(hint: hint);

Future<LNInvoice> parseInvoice({required String invoice, dynamic hint}) =>
    BreezSdkBindings.instance.api.parseInvoice(invoice: invoice, hint: hint);

Future<InputType> parseInput({required String input, dynamic hint}) =>
    BreezSdkBindings.instance.api.parseInput(input: input, hint: hint);

/// See [BreezServices::list_payments]
Future<List<Payment>> listPayments({required ListPaymentsRequest req, dynamic hint}) =>
    BreezSdkBindings.instance.api.listPayments(req: req, hint: hint);

/// See [BreezServices::list_payments]
Future<Payment?> paymentByHash({required String hash, dynamic hint}) =>
    BreezSdkBindings.instance.api.paymentByHash(hash: hash, hint: hint);
...
Future<void> setPaymentMetadata({required String hash, required String metadata, dynamic hint}) =>
    BreezSdkBindings.instance.api.setPaymentMetadata(hash: hash, metadata: metadata, hint: hint);

/// See [BreezServices::send_payment]
Future<SendPaymentResponse> sendPayment({required SendPaymentRequest req, dynamic hint}) =>
    BreezSdkBindings.instance.api.sendPayment(req: req, hint: hint);
...
Future<SendPaymentResponse> sendSpontaneousPayment(
    ...
    BreezSdkBindings.instance.api.sendSpontaneousPayment(req: req, hint: hint);
...
Future<RedeemOnchainFundsResponse> redeemOnchainFunds(
    ...
    BreezSdkBindings.instance.api.redeemOnchainFunds(req: req, hint: hint);
...
Future<PrepareRedeemOnchainFundsResponse> prepareRedeemOnchainFunds(
    ...
    BreezSdkBindings.instance.api.prepareRedeemOnchainFunds(req: req, hint: hint);

/// See [BreezServices::list_refundables]
Future<List<SwapInfo>> listRefundables({dynamic hint}) =>
    BreezSdkBindings.instance.api.listRefundables(hint: hint);
...
Future<PrepareRefundResponse> prepareRefund({required PrepareRefundRequest req, dynamic hint}) =>
    BreezSdkBindings.instance.api.prepareRefund(req: req, hint: hint);

/// See [BreezServices::refund]
Future<RefundResponse> refund({required RefundRequest req, dynamic hint}) =>
    BreezSdkBindings.instance.api.refund(req: req, hint: hint);

/// See [BreezServices::rescan_swaps]
Future<void> rescanSwaps({dynamic hint}) => BreezSdkBindings.instance.api.rescanSwaps(hint: hint);

/// See [BreezServices::redeem_swap]
Future<void> redeemSwap({required String swapAddress, dynamic hint}) =>
    BreezSdkBindings.instance.api.redeemSwap(swapAddress: swapAddress, hint: hint);

/// See [BreezServices::in_progress_swap]
Future<SwapInfo?> inProgressSwap({dynamic hint}) => BreezSdkBindings.instance.api.inProgressSwap(hint: hint);

/// See [BreezServices::in_progress_reverse_swaps]
Future<List<ReverseSwapInfo>> inProgressReverseSwaps({dynamic hint}) =>
    BreezSdkBindings.instance.api.inProgressReverseSwaps(hint: hint);
...
Future<OpenChannelFeeResponse> openChannelFee({required OpenChannelFeeRequest req, dynamic hint}) =>
    BreezSdkBindings.instance.api.openChannelFee(req: req, hint: hint);
...
Future<ReverseSwapPairInfo> fetchReverseSwapFees({required ReverseSwapFeesRequest req, dynamic hint}) =>
    BreezSdkBindings.instance.api.fetchReverseSwapFees(req: req, hint: hint);

/// See [BreezServices::onchain_payment_limits]
Future<OnchainPaymentLimitsResponse> onchainPaymentLimits({dynamic hint}) =>
    BreezSdkBindings.instance.api.onchainPaymentLimits(hint: hint);
