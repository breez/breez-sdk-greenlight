...
abstract class BreezSdkBindingsApiImplPlatform extends BaseApiImpl<BreezSdkBindingsWire> {
  ...
  void cst_api_fill_to_wire_node_state(NodeState apiObj, wire_cst_node_state wireObj) {
    ...
    wireObj.max_receivable_single_payment_amount_msat =
        cst_encode_u_64(apiObj.maxReceivableSinglePaymentAmountMsat);
...
class BreezSdkBindingsWire implements BaseWire {
  ...
  void wire__crate__binding__claim_reverse_swap(
    ...
    return _wire__crate__binding__claim_reverse_swap(
      port_,
      lockup_address,
    );
  }
...
const int SWAP_INVOICE_CLTV_DELTA = 36;
