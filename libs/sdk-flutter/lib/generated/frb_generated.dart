...
class BreezSdkBindings
  ...
  static void initMock({
    required BreezSdkBindingsApi api,
  }) {
...
class BreezSdkBindingsApiImpl extends BreezSdkBindingsApiImplPlatform implements BreezSdkBindingsApi {
  ...
  TaskConstMeta get kCrateBindingClaimReverseSwapConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kCrateBindingSyncConstMeta => const TaskConstMeta(
        debugName: "sync(dart_style=sync)",
        argNames: [],
      );
    ...
    switch (raw[0]) {
      ...
      case 8:
        return BreezEvent_ReverseSwapUpdated(
          details: dco_decode_box_autoadd_reverse_swap_info(raw[1]),
        );
      case 9:
  ...
  BuyBitcoinRequest sse_decode_buy_bitcoin_request(SseDeserializer deserializer) {
    ...
    return BuyBitcoinRequest(
        provider: var_provider, openingFeeParams: var_openingFeeParams, redirectUrl: var_redirectUrl);
  }
  ...
  OnchainPaymentLimitsResponse sse_decode_onchain_payment_limits_response(SseDeserializer deserializer) {
    ...
    return OnchainPaymentLimitsResponse(
        minSat: var_minSat, maxSat: var_maxSat, maxPayableSat: var_maxPayableSat);
  }
  ...
  SendPaymentRequest sse_decode_send_payment_request(SseDeserializer deserializer) {
    ...
    var var_label = sse_decode_opt_String(deserializer);
    return SendPaymentRequest(
        bolt11: var_bolt11, useTrampoline: var_useTrampoline, amountMsat: var_amountMsat, label: var_label);
  }
