...
abstract class BreezSdkBindingsApi extends BaseApi {
  ...
  Future<Stream<BreezEvent>> crateBindingBreezEventsStream({dynamic hint});

  Future<Stream<LogEntry>> crateBindingBreezLogStream({dynamic hint});
...
class BreezSdkBindingsApiImpl extends BreezSdkBindingsApiImplPlatform implements BreezSdkBindingsApi {
  ...
  @override
  Future<Stream<BreezEvent>> crateBindingBreezEventsStream({dynamic hint}) async {
  ...
  @override
  Future<Stream<LogEntry>> crateBindingBreezLogStream({dynamic hint}) async {
