...
class _$BreezEvent_NewBlockImpl extends BreezEvent_NewBlock {
  const _$BreezEvent_NewBlockImpl({required this.block}) : super._();
...
class _$BreezEvent_InvoicePaidImpl extends BreezEvent_InvoicePaid {
  const _$BreezEvent_InvoicePaidImpl({required this.details}) : super._();
...
class _$BreezEvent_SyncedImpl extends BreezEvent_Synced {
  const _$BreezEvent_SyncedImpl() : super._();
...
abstract class BreezEvent_Synced extends BreezEvent {
  const factory BreezEvent_Synced() = _$BreezEvent_SyncedImpl;
  const BreezEvent_Synced._() : super._();
}
...
class _$BreezEvent_PaymentSucceedImpl extends BreezEvent_PaymentSucceed {
  const _$BreezEvent_PaymentSucceedImpl({required this.details}) : super._();
...
class _$BreezEvent_PaymentFailedImpl extends BreezEvent_PaymentFailed {
  const _$BreezEvent_PaymentFailedImpl({required this.details}) : super._();
...
class _$BreezEvent_BackupStartedImpl extends BreezEvent_BackupStarted {
  const _$BreezEvent_BackupStartedImpl() : super._();
...
abstract class BreezEvent_BackupStarted extends BreezEvent {
  const factory BreezEvent_BackupStarted() = _$BreezEvent_BackupStartedImpl;
  const BreezEvent_BackupStarted._() : super._();
}
...
class _$BreezEvent_BackupSucceededImpl extends BreezEvent_BackupSucceeded {
  const _$BreezEvent_BackupSucceededImpl() : super._();
...
abstract class BreezEvent_BackupSucceeded extends BreezEvent {
  const factory BreezEvent_BackupSucceeded() = _$BreezEvent_BackupSucceededImpl;
  const BreezEvent_BackupSucceeded._() : super._();
}
...
class _$BreezEvent_BackupFailedImpl extends BreezEvent_BackupFailed {
  const _$BreezEvent_BackupFailedImpl({required this.details}) : super._();
...
class _$BreezEvent_ReverseSwapUpdatedImpl extends BreezEvent_ReverseSwapUpdated {
  const _$BreezEvent_ReverseSwapUpdatedImpl({required this.details}) : super._();
...
class _$BreezEvent_SwapUpdatedImpl extends BreezEvent_SwapUpdated {
  const _$BreezEvent_SwapUpdatedImpl({required this.details}) : super._();
