...
use gl_client::bitcoin::key::KeyPair;
use gl_client::bitcoin::sighash::EcdsaSighashType;
use gl_client::bitcoin::{absolute, ScriptBuf};
use rand::thread_rng;
...
use crate::bitcoin::{
    Address, AddressType, Network, OutPoint, Script, Sequence, Transaction, TxIn, TxOut, Txid,
    Witness,
};
