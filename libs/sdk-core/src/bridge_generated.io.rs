...
#[no_mangle]
pub extern "C" fn wire_check_initialized(port_: i64) {
    wire_check_initialized_impl(port_)
}
...
#[no_mangle]
pub extern "C" fn wire_convert_mnemonic_to_seed(port_: i64, phrase: *mut wire_uint_8_list) {
    wire_convert_mnemonic_to_seed_impl(port_, phrase)
}

#[no_mangle]
pub extern "C" fn wire_get_default_config(
    port_: i64,
    env_type: i32,
    api_key: *mut wire_uint_8_list,
    node_config: *mut wire_NodeConfig,
) {
    wire_get_default_config_impl(port_, env_type, api_key, node_config)
}
...
#[no_mangle]
pub extern "C" fn wire_get_lsp_id(port_: i64) {
    wire_get_lsp_id_impl(port_)
}
...
#[no_mangle]
pub extern "C" fn wire_get_backup_status(port_: i64) {
    wire_get_backup_status_impl(port_)
}
...
#[no_mangle]
pub extern "C" fn wire_parse_input(port_: i64, s: *mut wire_uint_8_list) {
    wire_parse_input_impl(port_, s)
}
...
#[no_mangle]
pub extern "C" fn wire_get_payment_by_hash(port_: i64, hash: *mut wire_uint_8_list) {
    wire_get_payment_by_hash_impl(port_, hash)
}
...
#[no_mangle]
pub extern "C" fn wire_list_refundable_swaps(port_: i64) {
    wire_list_refundable_swaps_impl(port_)
}
...
#[no_mangle]
pub extern "C" fn wire_get_in_progress_swap(port_: i64) {
    wire_get_in_progress_swap_impl(port_)
}

#[no_mangle]
pub extern "C" fn wire_list_in_progress_reverse_swaps(port_: i64) {
    wire_list_in_progress_reverse_swaps_impl(port_)
}
...
#[no_mangle]
pub extern "C" fn wire_fetch_recommended_fees(port_: i64) {
    wire_fetch_recommended_fees_impl(port_)
}
