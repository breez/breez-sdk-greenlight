...
curl https://mvn.breez.technology/snapshots/breez_sdk/bindings-android/$VERSION/bindings-android-$VERSION.aar --insecure --output bindings-android-$VERSION.aar
curl https://mvn.breez.technology/snapshots/breez_sdk/bindings-android/$VERSION/bindings-android-$VERSION.module --insecure --output bindings-android-$VERSION.module
curl https://mvn.breez.technology/snapshots/breez_sdk/bindings-android/$VERSION/bindings-android-$VERSION-sources.jar --insecure --output bindings-android-$VERSION-sources.jar
curl https://mvn.breez.technology/snapshots/breez_sdk/bindings-android/$VERSION/bindings-android-$VERSION.pom --insecure --output bindings-android-$VERSION.pom
